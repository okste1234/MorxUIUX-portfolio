...
const Contents = () => {
	...
	return (
		<div className="w-full 2xl:w-2/3 xl:w-5/6 m-auto mt-2 mb-10 sm:mt-32 lg:mt-28 sm:mb-28 px-2 sm:px-[53px]">
			<div className="text-[16px] mb-6 sm:mb-8 xl:mb-12">
				<Link href={"#links"}>
					<p className="font-semibold sm:font-bold sm:pt-3 pb-3 sm:pb-4 xl:pb-10 font2">
						MorxUIUX Portfolio (Links Below)
					</p>
				</Link>
				<p className="font-light pb-3 sm:pb-4 xl:pb-10 text-sm xs:text-[16px]">
				...
				<p className="font-light text-sm xs:text-[16px]">Thank you.</p>
			</div>
			...
			<div className="mt-0 sm:mt-2 text-[16px] mb-4 sm:mb-12">
				...
				<ul className="font-light list-disc pl-6">
			...
			<div className="text-base mb-9" id="links">
				...
				<p className="text-[#1E1E1E] font-light py-2 sm:py-4">
